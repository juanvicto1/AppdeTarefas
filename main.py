...
#Variavel para armazenar o frame tarefa que será editada
...
#Icones editar e deteletar
icon_editar = PhotoImage(file="edit.png").subsample(10, 10)  
icon_deletar = PhotoImage(file="delete.png").subsample(10, 10)  
